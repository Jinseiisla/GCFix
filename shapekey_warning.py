bl_info = {
    "name": "Basis Shapekey Warning",
    "author": "Ruuubick / Edited By Jin",
    "version": (1, 0),
    "blender": (2, 80, 0),
    ...
    if context.mode == 'EDIT_MESH':
        ...
        if obj and obj.type == 'MESH' and obj.data.shape_keys:
            ...
            if shapekey and shapekey.name == 'Basis':
                ...
                blf.color(font_id, 0,0,0, prefs.text_color[3])
                blf.position(font_id, prefs.location_x, prefs.location_y - 10, 0)
                ...
                blf.size(font_id, prefs.font_size)
                blf.color(font_id, prefs.text_color[0], prefs.text_color[1], prefs.text_color[2], prefs.text_color[3])
                blf.position(font_id, prefs.location_x, prefs.location_y - 5, 0)
                blf.draw(font_id, prefs.warning_text)
...
class ShapeKeyWarningPreferences(bpy.types.AddonPreferences):
    ...
    warning_text: bpy.props.StringProperty(
        ...
        default="YOU ARE FUCKING WITH THE BASIS"
    )
